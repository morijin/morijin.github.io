...
$(function(){
		...
		function controller(target) {
		    ...
		    /* Next, Prev 버튼 이벤트 */
			this.initEvent = function() {
				$('#btnPrev2').click(that.onPrevCalendar);
				$('#btnNext2').click(that.onNextCalendar);
			}
		    ...
		    /* 달력 이동되면 상단에 현재 년 월 다시 표시 */
			this.changeMonth = function() {
				$('#currentDate2').text(that.getYearMonth(m_oMonth).substr(0,9));
			}
